...
@Module({
  imports: [UsersModule, PassportModule,SessionModule, EnvironmentModule,
      JwtModule.register({}),
  ],
  controllers: [AuthController],
  providers: [AuthService, LocalStrategy, FinancialJwtStrategy, KeychainJwtStrategy, FinancialJwtAuthGuard, KeychainJwtAuthGuard],
})
